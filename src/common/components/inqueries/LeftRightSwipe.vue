...
<template>
  <div
    class="w-full h-full min-h-24 relative overflow-hidden select-none cursor-pointer flex justify-center items-center"
    ref="containerRef"
  >
    <div
      ref="targetRef"
      class="w-full h-full flex justify-center items-center absolute top-0 left-0 border border-gray-300 rounded-md shadow-sm bg-gray-50"
      :class="{
